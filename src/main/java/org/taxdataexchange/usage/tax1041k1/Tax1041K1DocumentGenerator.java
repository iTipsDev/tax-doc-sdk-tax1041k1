...
import irs.fdxtax641.jsonserializers.Tax1041K1Serializer;
import irs.fdxtax641.map2objects.Map2Tax1041K1;
import org.taxdataexchange.core.pdfbuilders.Tax1041K1PdfBuilder;
...
public class Tax1041K1DocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1041K1 obj = Map2Tax1041K1.generate( row );
        {
            String asJson = Tax1041K1Serializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1041K1.csv";
        ...
        String outputFileName = "Tax1041K1.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1041K1DocumentGenerator generator = new Tax1041K1DocumentGenerator( );
